...
namespace Exercise6
{
    ...
    {
        public static IEnumerable<Emp> Employees { get; set; }
        public static IEnumerable<Dept> Departments { get; set; }
        ...
        {
            IEnumerable<Emp> result = Employees.Where(emp => emp.Job == "Backend programmer");
            return result;
        }
        ...
        {
            IEnumerable<Emp> result = Employees.Where(emp => emp.Job == "Frontend programmer" && emp.Salary > 1000 )
        ...
        {
            int result = Employees.Max(emp => emp.Salary);
            return result;
        }
        ...
        {
            IEnumerable<Emp> result = Employees.Where(emp =>emp.Salary==Employees.Max(emp1 =>emp1.Salary) );
            return result;
        }
        ...
        {
            IEnumerable<object> result = Employees.Select(emp => new
            {
                Nazwisko=emp.Ename,
                Praca=emp.Job
            });
        ...
        {
            IEnumerable<object> result = Employees.Join(Departments,
                emp => emp.Deptno,
                dept => dept.Deptno,
                (emp, dept) => new
                {
        ...
        {
            bool result = Employees.Any(emp => emp.Job == "Backend programmer");
            return result;
        }
        ...
        {
            IEnumerable<object> result = Departments.GroupJoin(Employees,
                    dept =>dept.Deptno,
                    emp => emp.Deptno,
                    (dept,emp)=> new
                    {
        ...
        {
            IEnumerable<Emp> result = Employees.WithMgr();
            return result;
        }
        ...
        {
            IEnumerable<Dept> result = Departments
                .GroupJoin(
                    Employees,
                    dept => dept.Deptno,
                    emp => emp.Deptno,
    ...
    {
        public static IEnumerable<Emp> WithMgr(this IEnumerable<Emp> employees)
        {
            return employees
                .Where(emp => employees
